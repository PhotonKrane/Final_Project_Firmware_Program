...
int default_hall_min = 1750;
int default_hall_max = 2150;
int activeAngles[5] = { 96, 92, 90, 0, 0 };
int stopAngles[5] = { 92, 89, 91, 0, 0 };

int leds[5] = { 35, 36, 16, -1, -1 };
